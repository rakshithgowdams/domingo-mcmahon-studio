...
const SECTIONS: SectionEntry[] = [
  { id: "preloader", label: "Preloader", notes: "Skeleton shimmer + upward wipe reveal", Component: Preloader },
...
export default function QA() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-screen-2xl px-4 py-6 space-y-12">
        {visible.map(({ id, label, notes, Component }, i) => (
          <section key={id} id={`qa-${id}`} className="scroll-mt-32">
            {/* Label bar */}
